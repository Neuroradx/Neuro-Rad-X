...
import { Bar, BarChart, CartesianGrid, XAxis, YAxis, ResponsiveContainer, Cell, Legend, Pie, PieChart } from 'recharts';
    ...
    return (
        <div className="infographic-layout space-y-8">
            ...
            <header className="infographic-header">
                ...
                <p className="infographic-subtitle">Integrated Perspectives from Neuroradiology, Neurosurgery, and Neurology</p>
            </header>

            <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">

                {/* Definition & Clinical Context */}
                <Card className="infographic-card md:col-span-2 lg:col-span-3">
                    <CardHeader>
                ...
                <Card className="infographic-card md:col-span-2 lg:col-span-2">
                    <CardHeader>
                        <CardTitle className="flex items-center text-xl">
                ...
                <Card className="infographic-card md:col-span-2 lg:col-span-2">
                    ...
                    <CardContent>
                        <ChartContainer config={hemorrhageRiskConfig} className="infographic-chart min-h-[260px] w-full">
                            <ResponsiveContainer width="100%" height={300}>
                                <BarChart data={hemorrhageRiskData} margin={{ top: 20, right: 20, left: 0, bottom: 50 }}>
                                    ...
                                    <Bar dataKey="risk" name="Annual Risk" radius={[0, 8, 8, 0]} barSize={32}>
                ...
                <Card className="infographic-card">
                    ...
                    <CardContent>
                        <ChartContainer config={fiveYearRiskConfig} className="infographic-chart min-h-[260px] w-full">
                            <ResponsiveContainer width="100%" height={300}>
                                <BarChart accessibilityLayer data={fiveYearRiskData} margin={{ top: 10, right: 10, left: -20, bottom: 50 }}>
                                    ...
                                    <YAxis unit="%" />
                                    <ChartTooltip cursor={{ fill: 'hsl(var(--muted)/0.3)' }} content={<ChartTooltipContent indicator="dot" />} />
                                    <Bar dataKey="risk" name="5-Year Risk" fill="var(--color-risk)" radius={[0, 8, 8, 0]} barSize={32} />
                                </BarChart>
                            </ResponsiveContainer>
                        </ChartContainer>
                    </CardContent>
            ...
            <footer className="infographic-footer">
                ...
                <p className="mt-2">
                    Created by <a href="https://www.neuroradx.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">NeuroRadX</a> on October 8, 2025. Generated with Gemini.
                </p>
            </footer>
