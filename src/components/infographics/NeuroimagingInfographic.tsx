    ...
    return (
        <div className="infographic-layout space-y-8">
            <header className="infographic-header">
                ...
                <p className="infographic-subtitle">A Guide to Key Diagnostic Applications</p>
            </header>
                ...
                <Card className="infographic-card md:col-span-2">
                    ...
                    <CardContent className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <Card className="infographic-card-inner">
                            ...
                            <CardContent>
                                <ChartContainer config={diagnosticAccuracyConfig} className="infographic-chart min-h-[260px] w-full">
                                    <ResponsiveContainer width="100%" height={260}>
                                        <BarChart accessibilityLayer data={diagnosticAccuracyData} layout="vertical">
                                            ...
                                            <Bar dataKey="accuracy" fill="var(--color-accuracy)" radius={[0, 8, 8, 0]} barSize={32} />
                                        </BarChart>
                                    </ResponsiveContainer>
                                </ChartContainer>
                            </CardContent>
