    ...
    return (
        <div className="infographic-layout space-y-8">
            ...
            <header className="infographic-header">
                ...
                <p className="infographic-subtitle">A Guide to CTP, MRP, and Clinical Applications</p>
            </header>
                ...
                <Card className="infographic-card">
                    ...
                    <CardContent>
                        ...
                        <Card className="infographic-card-inner">
                            ...
                            <CardContent>
                                <ChartContainer config={trialCriteriaConfig} className="infographic-chart min-h-[260px] w-full">
                                    <ResponsiveContainer width="100%" height={200}>
                                        <BarChart accessibilityLayer data={trialCriteriaData}>
                                            ...
                                            <Bar dataKey="value" fill="var(--color-value)" radius={[0, 8, 8, 0]} barSize={32} />
                                        </BarChart>
                                    </ResponsiveContainer>
                                </ChartContainer>
                            </CardContent>
